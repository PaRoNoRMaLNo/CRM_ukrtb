...
@class Lottie_Forms_Platforms_Ios_AnimationViewRenderer;
...
@interface Lottie_Forms_Platforms_Ios_AnimationViewRenderer : Xamarin_Forms_Platform_iOS_ViewRenderer_2 {
}
	-(id) init;
@end
...
@interface LOTColorBlockCallback : NSObject {
	...
	-(id) callback;
	-(void) setCallback:(void * (^)(void *, void *, void *, void *, id, id, id))p0;
	-(id) init;
@end
...
@interface LOTNumberBlockCallback : NSObject {
	...
	-(CGFloat) floatValueForFrame:(CGFloat)p0 startKeyframe:(CGFloat)p1 endKeyframe:(CGFloat)p2 interpolatedProgress:(CGFloat)p3 startValue:(CGFloat)p4 endValue:(CGFloat)p5 currentValue:(CGFloat)p6;
	-(id) callback;
	-(void) setCallback:(void * (^)(void *, void *, void *, void *, void *, void *, void *))p0;
	-(id) init;
@end
...
@interface LOTPathBlockCallback : NSObject {
	...
	-(id) callback;
	-(void) setCallback:(id (^)(void *, void *, void *, void *))p0;
	-(id) init;
@end
...
@interface LOTAnimationView : UIView {
	...
	-(void) pause;
	-(void) play;
	-(void) playFromFrame:(NSNumber *)p0 toFrame:(NSNumber *)p1 withCompletion:(void (^)(BOOL))p2;
	-(void) playFromProgress:(CGFloat)p0 toProgress:(CGFloat)p1 withCompletion:(void (^)(BOOL))p2;
	-(void) playToFrame:(NSNumber *)p0 withCompletion:(void (^)(BOOL))p1;
	-(void) playToProgress:(CGFloat)p0 withCompletion:(void (^)(BOOL))p1;
	-(void) playWithCompletion:(void (^)(BOOL))p0;
	...
	-(id) completionBlock;
	-(void) setCompletionBlock:(void (^)(BOOL))p0;
