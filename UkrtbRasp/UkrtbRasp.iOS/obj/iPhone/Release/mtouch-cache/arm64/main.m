...
extern void *mono_aot_module_UkrtbRasp_iOS_info;
...
extern void *mono_aot_module_UkrtbRasp_info;
...
{
	mono_aot_register_module (mono_aot_module_UkrtbRasp_iOS_info);
	...
	mono_aot_register_module (mono_aot_module_UkrtbRasp_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "UkrtbRasp.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
